...
const src = 'https://cataas.com/cat/gif/says/CatJam'
  ...
  variants: {
    variant: {
      violet: {
        ...
        textTransform: `uppercase`,
        color:`#812435`,
        backgroundImage: `linear-gradient(to left, pink, lightblue)`,
        '&:hover': { backgroundImage: `linear-gradient(to left, lightblue, pink)` },
        //'&:hover': { backgroundColor: mauve.mauve3 },
        '&:focus': { boxShadow: `0 0 0 0px black` },
      },
      red: {
  ...
  <AlertDialog>
    ...
    <AlertDialogContent >
      ...
      <AlertDialogDescription>
        <Image loader={() => src} alt="CatJam" src={src} width={300} height={300} />
      </AlertDialogDescription>
