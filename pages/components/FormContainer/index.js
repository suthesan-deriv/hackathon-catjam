...
const FormContainer = () => {
	...
	const getImage = () => {
		...
		fetch('https://cataas.com/cat/gif/says/CatJam').then(res => res)
			.then(({ url = '', error }) => {
	...
	return (
		<div className={flexBetween}>
			<div className={formContainer}>
				...
				/>
				<button className={getQrButton} onClick={() => handleGetQr(data)}>Generate QR</button>
			
			</div>
			<BarcodeComponent gif={gif_url} />
			{
				isLoading ? <Loader /> : ""
			}
		</div>
